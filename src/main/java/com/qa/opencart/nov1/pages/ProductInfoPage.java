...
private final By header = By.tagName("h1");//MacBook
...
public int getProuctImages() {
 int imagesCount =	eleUtil.waitForElementsVisible(productImages, AppConstants.DEFAULT_SHORT_WAIT).size();
...
public Map<String, String> getProductData(){
 ...
 productMap.put("productimages", String.valueOf(getProuctImages()));
...
private void getProductPriceData() {
 ...
 System.out.println("total price data: " + priceList.size());//2	
  ...
  productMap.put("exTaxValue", exTaxValue);
